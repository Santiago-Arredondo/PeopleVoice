...
if (isset($_POST['enviar'])) {
    ...
    $sql = "SELECT * FROM oyente WHERE email = '$correo' AND id='$id'";
...
<body background="img/fondo.jpg" , background-size="cover" , background-repeat="no-repeat" , background-position="center" , background-attachment="fixed">
    ...
    <form action="restaurarO.php" method="POST" autocomplete="off">
    ...
    if (isset($_POST['aceptar'])) {
        ...
        $query = "UPDATE oyente SET password='$newPassword' WHERE id='$id'";
        ...
        if ($consulta1) {
           ...
           alert('No se pudo cambiar la contraseña, intente nuevamente')
            window.location.href='./restaurarO.php'
            </script>
            ";
        }
    }
